	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<img src="../assets/unimal.png" width="80px" height="80px" alt="" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					<ul class="nav-menu">
					 <li class="active"><a href="index.php">Home</a></li>
				<li class="active1"><a href="rekom_rs.php">Rekomendasi RS</a></li>
				<li class="active2"><a href="peta3.php">Peta Djikstra</a></li>
				</li>
					</ul>
